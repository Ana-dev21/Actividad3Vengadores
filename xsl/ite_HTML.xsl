        ...
        <html>
            ...
            <body>
                <div class="contenedor">
                    ...
                    <header>
                        <h1>
                            <xsl:value-of select="@nombre" /> //Selecciona el atributo nombre
                        </h1>
                        <h2>
                            Teléfono de contacto: <xsl:value-of select="teléfono" /><br/>
                    ...
                    <section>
                        ...
                        <ul>
                            ...
                            <li>
                                Jefe de estudios: <xsl:value-of select="director/nombre"/> <br/> Despacho: <xsl:value-of select="director/despacho"/>
                            </li>
                        </ul>
                        ...
                        <form>
                            <div class="formulario">
                                <p>
                                    ...
                                    <input type="text" name="nombre" placeholder="Escribe tu Nombre y Apellidos" size="35" autofocus=""></input>
                                </p>
                                <p>
                                    <label for="email">E-mail: </label>
                                    <input type="email" name="email" placeholder="Escribe tu email" size="35" required="" />
                                </p>
                                <!-- Desplegable con los ciclos formativos-->
                                <p>
                                    <label for="cilo">Ciclo: </label>
                                    <select name="ciclo">
